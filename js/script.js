...
window.addEventListener('DOMContentLoaded', () => {
    ...
    function postData(form) {
        form.addEventListener('submit', (e) => {
            ...
            request.setRequestHeader('Content-type', 'application/json'); //приLoadВводитьНеНужно
            ...
            request.addEventListener('load', () => {
                if (request.status === 200) {
                    ...
                    form.reset(); //сбросФормы
                    setTimeout(() => {
                        statusMessage.remove(); //удаляетСообщениеСоСтраницыЧерез2Сек
                    }, 2000);
                } else {
